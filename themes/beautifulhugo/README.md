...
![Beautiful Hugo Theme Screenshot](https://github.com/qietingfengling/beautifulhugo/blob/master/images/screenshot.png)

## Installation

    $ mkdir themes
    $ cd themes
    $ git clone https://github.com/qietingfengling/beautifulhugo.git beautifulhugo
...
MIT Licensed, see [LICENSE](https://github.com/qietingfengling/Hugo-BeautifulHugo/blob/master/LICENSE).
